...
function setup() {
  let sheet = resources["assets/spritesheet.json"];
  ...
  animatedAnt = new AnimatedSprite(id.animations["Knap"]);
  animatedAnt.animationSpeed = 0.15;
  animatedAnt.play();
  gameScene.addChild(animatedAnt)
